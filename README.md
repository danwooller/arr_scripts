...
| [**DW_extract_subtitles_movies.sh**](./DW_extract_subtitles_movies.sh) | Looks for mkv files in $DIR\_MEDIA\_TORRENT/${HOST}/subtitles/extract/movies and extracts subtitles to $DIR\_MEDIA\_SUBTITLES. _Running on ubuntu9_ |
| [**DW_extract_subtitles_tv.sh**](./DW_extract_subtitles_tv.sh) | Looks for mkv files in $DIR\_MEDIA\_TORRENT/${HOST}/subtitles/extract/tv and extracts subtitles to $DIR\_MEDIA\_SUBTITLES. _Running on ubuntu9_ |
