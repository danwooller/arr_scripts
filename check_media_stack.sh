...
# Pi-hole
check_service "Pi-hole (9)" "$PIHOLE9_API_BASE" "$PIHOLE9_API_KEY" "?status&auth=$PIHOLE9_API_KEY"
check_service "Pi-hole (24)" "$PIHOLE24_API_BASE" "$PIHOLE24_API_KEY" "?status&auth=$PIHOLE24_API_KEY"
